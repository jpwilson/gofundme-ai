          ...
          <div className="grid grid-cols-1 gap-8 py-10 md:grid-cols-[1fr_1fr] lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="flex flex-col justify-center gap-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  aria-label="Share"
                  className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-gfm-border text-gfm-secondary transition hover:bg-gray-100 hover:border-gray-300"
                >
        ...
        <div className="mx-auto max-w-6xl px-4 py-6">
          <div className="grid grid-cols-3 gap-4 text-center md:gap-8">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-400">Raised</p>
            </div>
            <div className="border-x border-gray-700">
              <p className="text-2xl font-bold text-white md:text-3xl">
                {formatNumber(community.totalDonations)}
              </p>
              <p className="mt-1 text-sm text-gray-400">Donations</p>
            </div>
            <div>
              <p className="text-2xl font-bold text-white md:text-3xl">
                {formatNumber(community.totalFundraisers)}
              </p>
              <p className="mt-1 text-sm text-gray-400">Fundraisers</p>
            </div>
          </div>
        </div>
      </div>
