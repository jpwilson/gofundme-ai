...
const TOUR_STEPS = [
  ...
  },
  {
    ...
    description: 'Every AI call is traced via LangFuse — provider, model, tokens, latency, and success/failure. The overview tab shows real-time metrics from your browsing session.',
    path: '/ai/analytics',
    highlight: 'See total calls, success rate, and latency',
    scrollTo: null,
  },
  {
    title: 'Feature Costs',
    description: 'Each AI feature has different token budgets and temperatures. See per-feature cost breakdowns — story coach vs. sentiment vs. trust scoring — and how they compare.',
    path: '/ai/analytics',
    highlight: 'Switch to the "Feature Costs" tab',
    scrollTo: null,
  },
  {
    title: 'Scale Projections',
    description: 'What does AI cost at scale? See projections from 1K to 1M monthly active users — with Haiku vs. Sonnet pricing and estimated monthly spend.',
    path: '/ai/analytics',
    highlight: 'Switch to the "Scale Projections" tab',
    scrollTo: null,
  },
  {
    title: 'Development Costs',
    description: 'Full transparency on what it cost to build this prototype — hours spent, AI API costs during development, and per-feature breakdown.',
    path: '/ai/analytics',
    highlight: 'Switch to the "Development Costs" tab',
    scrollTo: null,
  },
  {
    title: 'Chat Agent + Guardrails',
    description: 'The AI chat agent (bottom-right) is constrained to only discuss this project. It has a strict system prompt, post-response guardrails, and 5 eval tests validating jailbreak resistance.',
    path: '/docs',
    highlight: null,
    scrollTo: null,
  },
  ...
  {
    title: 'Documentation',
    description: 'The docs page ties everything together — features, metrics rationale, architecture, and philosophy. Thanks for taking the tour!',
    path: '/docs',
    highlight: null,
    scrollTo: null,
  },
...
const PAGE_LINKS: Record<string, { label: string; href: string }> = {
  ...
  'ai fundraiser': { label: 'AI Fundraiser', href: '/ai/fundraiser' },
  'story coach': { label: 'AI Fundraiser', href: '/ai/fundraiser' },
  community: { label: 'Community Page', href: '/communities/watch-duty' },
  'ai community': { label: 'AI Community', href: '/ai/community' },
  digest: { label: 'AI Community', href: '/ai/community' },
  profile: { label: 'Profile Page', href: '/u/janahan' },
  'ai profile': { label: 'AI Profile', href: '/ai/profile' },
  personality: { label: 'AI Profile', href: '/ai/profile' },
  fraud: { label: 'Fraud Detection', href: '/ai2/fraud-detection' },
  trust: { label: 'Fraud Detection', href: '/ai2/fraud-detection' },
  ...
  persona: { label: 'Persona Recommendations', href: '/ai2/persona-recommendations' },
  jira: { label: 'Jira Agent', href: '/ai2/jira-agent' },
  observability: { label: 'Agent Observability', href: '/ai2/agent-observability' },
  sentiment: { label: 'AI Fundraiser', href: '/ai/fundraiser' },
};
