// ============================================================
// GoFundMe Clone - TypeScript Type Definitions
// ============================================================
...
export interface Fundraiser {
  ...
  beneficiary: { name: string; avatarUrl: string | null; isVerified: boolean } | null;
  communityId: string | null;
  community: { name: string; slug: string; iconUrl: string | null } | null;
  title: string;
  description: string;
...
export interface Donation {
  ...
  fundraiserId: string;
  donorId: string | null;
  donor: { displayName: string; avatarUrl: string | null } | null;
  amount: number; // cents
  tipAmount: number;
  isAnonymous: boolean;
  displayName: string;
...
export interface Activity {
  ...
  fundraiser: Pick<Fundraiser, 'title' | 'slug' | 'coverImageUrl' | 'raisedAmount' | 'goalAmount'> | null;
  communityId: string | null;
...
export interface Highlight {
  id: string;
  fundraiserId: string;
  fundraiser: Pick<Fundraiser, 'title' | 'slug' | 'coverImageUrl' | 'raisedAmount' | 'goalAmount' | 'donationCount'>;
  displayOrder: number;
}

// --- GivingPledge (AI Giving Agent feature) ---
